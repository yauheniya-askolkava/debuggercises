...
const _1_actual = mystery('a', 'string');
...
const _4_actual = mystery("string", "b");
...
const _7_actual = mystery(undefined, "boolean");
console.assert(_7_actual === _7_expect, 'Test 7');

const _8_expect = 'path 3';
const _8_actual = mystery(0, "string");
console.assert(_8_actual === _8_expect, 'Test 8');

const _9_expect = 'path 3';
const _9_actual = mystery(false, "number");
